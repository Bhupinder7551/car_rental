...
<section class="">
	...
	<section class="listings">
		<div class="wrapper">
			...
			?>
				...
				<h3>Proceed to Hire - <u><?php echo $rws['car_name'];?></u>. </h3>
				<?php
				...
				<?php
						...
						{
							?>
								<!-- <a href="book_car.php?booking">Click to Book </a>  -->
								<form method="post">
					
				
						
							<input type="submit" name="booking" value="Click to book">
	...
	<?php
		if(isset($_POST['booking'])){
			...
			$qry = "UPDATE client SET status ='Pending', car_id ='$carid'  WHERE email='$email'";
	...
	<h3>Related Car for Hire -  </h3>
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
			<?php
						include 'includes/config.php';
						$sel = "SELECT * FROM cars  WHERE status = 'Available' AND car_id != '$_GET[id]'  LIMIT 3";
