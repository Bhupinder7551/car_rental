					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							$start_from = ($page-1) * $limit;  
								...
								$select = "SELECT * FROM cars WHERE status = 'Available' LIMIT $start_from, $limit";
...
$result_db = mysqli_query($conn,"SELECT COUNT(car_id) FROM cars"); 
...
for ($i=1; $i<=$total_pages; $i++) {
			  ...
			  $pagLink .= "	 <a href='add_vehicles.php?page=".$i."'>".$i."</a>	";
}
 "</ul>";  
?>
						<!-- Pagging -->
					...
					<h2><input type="submit" onclick="window.print()" value="Pdf" /></h2>
