...
<head>
	...
	<script type="text/javascript">
		...
		function read(id){
			if(confirm("Are you sure you want to read this message?")){
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['msg_id'];?>)" class="ico del">Delete</a><a href="javascript:read(<?php echo $row['msg_id'];?>)" name="read" class="ico ">Read</a><a href="#" class="ico edit">Edit</a></td>
							</tr>
							<?php
								}
							?>
