...
<head>
	...
	<script type="text/javascript">
		...
		function sureToApprovehirerequest(id){
			if(confirm("Are you sure you want to Delete this request?")){
				window.location.href ='delete_hire_request.php?id='+id;
			}
		}
	</script>
</head>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Approve</a><a href="javascript:sureToApprovehirerequest(<?php echo $row['client_id'];?>)" class="ico edit">Delete</a></td>
							</tr>
							<?php
								}
							?>
