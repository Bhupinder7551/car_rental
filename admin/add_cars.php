				...
				<div class="box">
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO cars (image, car_name,car_type,hire_cost,capacity,status,model) 
													VALUES ('$image','$car_name','$car_type','$hire_cost','$capacity','Available','$model')";
								$res = $conn->query($qr);
								if($res === TRUE){
